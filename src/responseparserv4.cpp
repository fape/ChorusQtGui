...
ResponseParserV4::ResponseParserV4(ChorusDevice * device): ResponseParser(device)
{
    qDebug() << "ResponseParserV4 created";
}

ResponseParserV4::~ResponseParserV4(){
    qDebug() << "ResponseParserV4 removed";
}


void ResponseParserV4::parse(QString cmd){
